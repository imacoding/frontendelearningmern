...
import { Card, CardHeader, CardMedia, Typography, IconButton, Button, List, ListItem, ListItemAvatar, Avatar, ListItemSecondaryAction, ListItemText, TextField, Divider } from '@material-ui/core';
...
export default function EditCourse() {
  ...
  const clickSubmit = () => {
    ...
    update({ courseId: courseId }, { t: jwt.token }, courseData).then((data) => {
      if (data && data.error) {

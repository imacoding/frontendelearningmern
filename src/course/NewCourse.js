...
export default function NewCourse() {
  ...
  if (values.redirect) {
    navigate('/teach/courses'); // Use navigate to redirect to the desired route
    return null; // Return null if redirecting to prevent rendering the component after redirect
  }
